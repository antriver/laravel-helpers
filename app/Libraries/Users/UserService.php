...
use Tmd\LaravelSite\Events\NewUserEvent;
use Tmd\LaravelSite\Models\User;
use Tmd\LaravelSite\Models\UserProfile;
use Tmd\LaravelSite\Models\UserSocialAccount;
use Tmd\LaravelSite\Repositories\UserProfileRepository;
...
class UserService
{
    ...
    public function createUser($data, Request $request = null)
    {
        ...
        /** @var User $user */
        $user = $this->userRepository->fresh($user);
        ...
        $this->userProfileRepository->persist($profile);

        event(new NewUserEvent($user, null));
